...
import { FiClock, FiLogIn, FiLogOut, FiCalendar, FiUsers, FiSearch, FiFilter, FiChevronDown, FiChevronUp, FiX, FiHome, FiCheck, FiUserCheck } from 'react-icons/fi';
    ...
    const fetchAllAttendance = async (isInitialLoad = false) => {
        try {
            ...
            if (response.data.success) {
                ...
                // Set today's attendance (not really needed for 'all' mode but kept for logic consistency)
                const today = dayjs().format('YYYY-MM-DD');
        ...
        <div className="attendance-list-page">
            ...
            <div className="attendance-page-header">
                ...
                <div className="header-actions">
                    {/* Command Center Mode: No toggle needed, purely 'all' view */}
                </div>
            </div>
                ...
                {showFilters && (
                    <div className="filter-panel-overlay fade-in" ref={filterRef} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-end', gap: '32px', width: '100%', flexWrap: 'wrap' }}>
                            ...
                            {/* Department - Always visible in HRM All view */}
                            {viewMode === 'all' && (
